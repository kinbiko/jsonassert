...
func TestAssertf(t *testing.T) {
	tt := []struct {
		...
		{name: "empty v null", act: "", exp: "null", msgs: []string{`could not find JSON type (string, number, null, boolean, object, or array) for actual JSON: unable to identify JSON type of ""`}},
		{name: "null v empty", act: "null", exp: "", msgs: []string{`could not find JSON type (string, number, null, boolean, object, or array) for expected JSON: unable to identify JSON type of ""`}},
